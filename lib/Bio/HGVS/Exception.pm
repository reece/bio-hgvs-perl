...
Bio::Unison::Exception -- base class for exceptions
S<$Id$>

=head1 SYNOPSIS

 use Bio::Unison::Exception;
...
B<Bio::Unison::Exception> is a base class for exceptions.  It may be used
...
A B<Bio::Unison::Exception> instance has these attributes:
...
When thrown, a B<Bio::Unison::Exception> looks like this:

 ! Bio::Unison::Exception occurred: invalid argument
